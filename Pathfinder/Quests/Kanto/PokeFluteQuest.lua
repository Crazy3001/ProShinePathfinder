...
function PokeFluteQuest:LavenderTown()
	...
	elseif dialogs.checkFujiHouse.state and not dialogs.checkFujiNote.state then
		return PathFinder.moveTo(getMapName(), "Lavender Town Volunteer House")
	elseif not hasItem("Poke Flute") then
		return PathFinder.moveTo(getMapName(), "Pokemon Tower 1F")
	else
...
function PokeFluteQuest:PokemonTower1F()
	if hasItem("Poke Flute") then
		...
		return PathFinder.moveTo(getMapName(), "Pokemon Tower 2F")
	end
end
...
function PokeFluteQuest:PokemonTower2F()
	if hasItem("Poke Flute") then
		...
		return PathFinder.moveTo(getMapName(), "Pokemon Tower 3F")
	end
end
...
function PokeFluteQuest:PokemonTower3F()
	if hasItem("Poke Flute") then
		...
		return PathFinder.moveTo(getMapName(), "Pokemon Tower 4F")
	end
end
...
function PokeFluteQuest:PokemonTower4F()
	if hasItem("Poke Flute") then
		...
		return PathFinder.moveTo(getMapName(), "Pokemon Tower 5F")
	end
end
...
function PokeFluteQuest:PokemonTower5F()
	if hasItem("Poke Flute") then
		...
		return PathFinder.moveTo(getMapName(), "Pokemon Tower 6F")
	end
end
...
function PokeFluteQuest:PokemonTower6F()
	if hasItem("Poke Flute") then
		...
		if isNpcOnCell(9,19) then
			...
			return PathFinder.moveTo(getMapName(), "Pokemon Tower 7F")
		end
	end
end
